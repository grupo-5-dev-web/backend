...
class TestEventHandlers:
    """Tests for the booking event handlers."""
    
    @pytest.mark.asyncio
    async def test_user_service_handle_booking_created(self):
        """Test the user service booking created handler."""
        from services.user.app.consumers.booking_consumer import handle_booking_created
    ...
    @pytest.mark.asyncio
    async def test_user_service_handle_booking_cancelled(self):
        """Test the user service booking cancelled handler."""
        from services.user.app.consumers.booking_consumer import handle_booking_cancelled
    ...
    @pytest.mark.asyncio
    async def test_user_service_handle_booking_status_changed(self):
        """Test the user service booking status changed handler."""
        from services.user.app.consumers.booking_consumer import handle_booking_status_changed
    ...
    @pytest.mark.asyncio
    async def test_resource_service_handle_booking_created(self):
        """Test the resource service booking created handler."""
        from services.resource.app.consumers.booking_consumer import handle_booking_created
    ...
    @pytest.mark.asyncio
    async def test_resource_service_handle_booking_cancelled(self):
        """Test the resource service booking cancelled handler."""
        from services.resource.app.consumers.booking_consumer import handle_booking_cancelled
    ...
    @pytest.mark.asyncio
    async def test_resource_service_handle_booking_updated(self):
        """Test the resource service booking updated handler."""
        from services.resource.app.consumers.booking_consumer import handle_booking_updated
